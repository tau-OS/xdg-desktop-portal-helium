...
on_name_acquired (GDBusConnection *connection,
                  ...
                  gpointer         user_data)
{
  g_debug ("org.freedesktop.impl.portal.desktop.helium acquired");
}
...
main (int argc, char *argv[])
{
  ...
  g_option_context_set_description (context,
      "xdg-desktop-portal-helium provides D-Bus interfaces that\n"
  ...
  g_set_prgname ("xdg-desktop-portal-helium");
  ...
  owner_id = g_bus_own_name (G_BUS_TYPE_SESSION,
                             "org.freedesktop.impl.portal.desktop.helium",
